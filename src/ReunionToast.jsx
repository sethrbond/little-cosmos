...
/**
 * Reunion detection — receives onlineUsers from App.jsx as prop.
 * CRITICAL: Must NOT import supabaseClient, useRealtimeSync, or any module
 * shared with OurWorld — doing so causes Rollup to re-chunk and TDZ.
 */
