...
export const OUR_WORLD_SCENE = {
  ...
  fog: "#161028",
  sphereColor: "#f0dce8",
  sphereEmissive: "#5a2868",
  ambientColor: "#fff2f0",
  sunColor: "#ffecf0",
  fillColor: "#f0dcf0",
  rimColor: "#f0a0c8",
  bottomColor: "#d8b8f0",
  glowColors: ["#e0a8f0", "#e4b8f4", "#f0d0ff", "#f8e0ff", "#fce8ff", "#fef0ff", "#fff4ff", "#fff8ff"],
  landColors: ["#e8b8d0", "#e0b8d8", "#e8c8d8", "#d8c0d8", "#f0c8e0"],
  particleColor: "#f0a8c8",
  particleColor2: "#d8b0e0",
  starTint: "#f8d4e0",
  coastColor: "#70b850",
};
...
export const MY_WORLD_SCENE = {
  ...
  fog: "#0c0e16",
  sphereColor: "#d0c0a0",
  sphereEmissive: "#201c28",
  ambientColor: "#f0e8e0",
  sunColor: "#f4ece0",
  fillColor: "#e0d8cc",
  rimColor: "#98acc0",
  bottomColor: "#8098b0",
  glowColors: ["#7088a8", "#7898b0", "#88a4b8", "#98b0c0", "#a0b8c8", "#a8c0d0", "#b0c8d8", "#b8d0e0"],
  landColors: ["#c0b090", "#b0a080", "#c8b8a0", "#b8a888", "#b0a078"],
  particleColor: "#98a8b8",
  particleColor2: "#b0b8a8",
  starTint: "#d0d8e0",
  coastColor: "#5a9848",
};
