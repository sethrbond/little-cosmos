...
export const OUR_WORLD_SCENE = {
  ...
  landColors: ["#f4d0e0", "#ecc8e8", "#f4d8e8", "#e8d0e8", "#fad8f0"],
...
export const MY_WORLD_SCENE = {
  ...
  rimColor: "#b0d0e8",
  bottomColor: "#98b0c8",
  glowColors: ["#90b0d0", "#98b8d8", "#a0c0e0", "#b0cce8", "#b8d4ec", "#c0dcf0", "#c8e4f4", "#d0e8f8"],
  landColors: ["#e0d0b0", "#d4c4a4", "#e4d8b8", "#d8c8a8", "#d0c098"],
  particleColor: "#b0c0d0",
  particleColor2: "#c0d0c0",
  starTint: "#d8e0f0",
  coastColor: "#80c868",
};
...
export const THEME_FIELDS = [
  { key: "space",     label: "Space Background", defaultOur: "#1c1434", defaultMy: "#141820" },
  { key: "globe",     label: "Globe Color",      defaultOur: "#fcf0f8", defaultMy: "#f0e0c8" },
  { key: "glow",      label: "Glow Halo",        defaultOur: "#f0b8f8", defaultMy: "#90b0d0" },
  ...
  { key: "coast",     label: "Coastlines",        defaultOur: "#88d868", defaultMy: "#80c868" },
  { key: "particles", label: "Particles",         defaultOur: "#f8b8d0", defaultMy: "#b0c0d0" },
